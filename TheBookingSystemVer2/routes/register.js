...
const registerSchema = z.object({
  username: z.string().email({ message: "Invalid email address" }).max(
    50,
...
export async function registerUser(c) {
  ...
  try {
    ...
    await client.queryArray(
      `INSERT INTO zephyr_users (username, password_hash, role, birthdate, terms_accepted) VALUES ($1, $2, $3, $4, $5)`,
      [username, hashedPassword, role, birthdate, terms_accepted === "on"],
    );
